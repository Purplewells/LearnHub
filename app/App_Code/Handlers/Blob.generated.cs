namespace zLearnHub.Handlers
{
    ...
    public partial class BlobFactoryConfig : BlobFactory
    {
        ...
        public static void Initialize()
        {
            ...
            RegisterHandler("FileHandler", "\"dbo\".\"DocumentStore\"", "\"Data\"", new string[] {
                        "\"DocID\""}, "Document Store Data", "DocumentStore", "Data");
            ...
            RegisterHandler("master_student_grades_gradebooks_p4PhotoUrl", "\"dbo\".\"master_student_grades_gradebooks_p4\"", "\"PhotoUrl\"", new string[] {
                        "\"PersonID\""}, "Historical Grades Photo Url", "HistoricalGrades", "PhotoUrl");
            RegisterHandler("master_student_grades_gradebooks_p4Logo", "\"dbo\".\"master_student_grades_gradebooks_p4\"", "\"Logo\"", new string[] {
                        "\"PersonID\""}, "Historical Grades Logo", "HistoricalGrades", "Logo");
            ...
            RegisterHandler("ProductPhotoHandler", "\"dbo\".\"Product\"", "\"Photo\"", new string[] {
                        "\"ProductID\""}, "Product Photo", "Product", "Photo");
