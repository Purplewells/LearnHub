...
namespace zLearnHub.Handlers
{
    ...
    public class SiteBase : zLearnHub.Web.PageBase
    {
        ...
        © 2018 Telleion MIS | <a href=""http://www.purplewells.com"" target=""_blank"">Purplewells Ltd</a> | Last Updated: 20250512 | V8.9</div>
</footer>
";
            }
        }
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            var themePath = Server.MapPath("~/App_Themes/zLearnHub");
            if (Directory.Exists(themePath))
                foreach (var stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!(fileName.Equals("_Theme_Aquarium.css")))
                    {
                        ...
                        {
                            Href = ("~/App_Themes/zLearnHub/" + fileName)
                        };
