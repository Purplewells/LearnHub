...
{
    public enum StudentGradeBookEntryDataField
    {
    ...
    public partial class StudentGradeBookEntryModel : BusinessRulesObjectModel
    {
        ...
        public StudentGradeBookEntryModel()
        {
        }

        public StudentGradeBookEntryModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[StudentGradeBookEntryDataField field]
        {
            get
            {
