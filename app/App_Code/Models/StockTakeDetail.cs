...
{
    public enum StockTakeDetailDataField
    {
    ...
    public partial class StockTakeDetailModel : BusinessRulesObjectModel
    {
        ...
        public StockTakeDetailModel()
        {
        }

        public StockTakeDetailModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[StockTakeDetailDataField field]
        {
            get
            {
