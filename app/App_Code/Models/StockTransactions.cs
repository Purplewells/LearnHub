...
{
    public enum StockTransactionsDataField
    {
    ...
    public partial class StockTransactionsModel : BusinessRulesObjectModel
    {
        ...
        public StockTransactionsModel()
        {
        }

        public StockTransactionsModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[StockTransactionsDataField field]
        {
            get
            {
