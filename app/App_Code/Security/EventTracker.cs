...
namespace zLearnHub.Security
{
    ...
    public class EventTrackerBase
    {
        ...
        private static Regex _modifiedOnRegex = new Regex("ModifiedDate", RegexOptions.IgnoreCase);
        ...
        private static Regex _createdOnRegex = new Regex("CreatedDate", RegexOptions.IgnoreCase);
