...
namespace zLearnHub.Data
{
    ...
    public class BusinessRulesBase : ActionHandlerBase, zLearnHub.Data.IRowHandler, zLearnHub.Data.IDataFilter, zLearnHub.Data.IDataFilter2
    {
        ...
        public virtual object GetProperty(string propertyName)
        {
            ...
            if (propertyName.StartsWith("Url_"))
            {
                ...
                if (!(string.IsNullOrEmpty(query)))
                {
                    if (query.StartsWith("?_link="))
                        query = ("?" + new StringEncryptor().Decrypt(query.Substring(7)));
