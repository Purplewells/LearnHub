...
namespace zLearnHub.Data
{
    ...
    public partial class DataControllerBase : IDataController, IAutoCompleteManager, IDataEngine, IBusinessObject
    {
        ...
        ViewPage IDataController.GetPage(string controller, string view, PageRequest request)
        {
            ...
            zLearnHub.Security.EventTracker.Process(page, request);
            if (rules != null)
        ...
        ActionResult IDataController.Execute(string controller, string view, ActionArgs args)
        {
            ...
            try
            {
                ...
                {
                    zLearnHub.Security.EventTracker.Process(args, _config);
        ...
        public virtual string GetSurvey(string surveyName)
        {
            ...
            if (string.IsNullOrEmpty(survey))
                survey = ControllerConfigurationUtility.GetResourceText(string.Format("zLearnHub.Surveys.{0}.min.js", surveyName), string.Format("zLearnHub.{0}.min.js", surveyName), string.Format("zLearnHub.Surveys.{0}.js", surveyName), string.Format("zLearnHub.{0}.js", surveyName));
            if (string.IsNullOrEmpty(survey))
                throw new HttpException(404, "Not found.");
            if (string.IsNullOrEmpty(layout))
                layout = ControllerConfigurationUtility.GetResourceText(string.Format("zLearnHub.Surveys.{0}.html", surveyName), string.Format("zLearnHub.Surveys.{0}.htm", surveyName), string.Format("zLearnHub.{0}.html", surveyName), string.Format("zLearnHub.{0}.htm", surveyName));
            if (string.IsNullOrEmpty(rules))
                rules = ControllerConfigurationUtility.GetResourceText(string.Format("zLearnHub.Surveys.{0}.rules.min.js", surveyName), string.Format("zLearnHub.{0}.rules.min.js", surveyName), string.Format("zLearnHub.Surveys.{0}.rules.js", surveyName), string.Format("zLearnHub.{0}.rules.js", surveyName));
