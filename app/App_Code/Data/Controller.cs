    ...
    public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                    res = ControllerConfigurationUtility.GetResourceStream(string.Format("zLearnHub.controllers.{0}.xml", controller), string.Format("zLearnHub.{0}.xml", controller));
                if (res == null)
                {
        ...
        protected virtual bool ConfigureCommand(DbCommand command, ViewPage page, CommandConfigurationType commandConfiguration, FieldValue[] values)
        {
            ...
            if (command == null)
                return true;
            if (values != null)
                zLearnHub.Security.EventTracker.EnsureTrackingFields(page, _config);
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            if (t == null)
                t = typeof(zLearnHub.Data.Controller);
            var res = ControllerConfigurationUtility.GetResourceStream(string.Format("zLearnHub.Reports.{0}", name), string.Format("zLearnHub.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                var config = zLearnHub.Data.Controller.CreateConfigurationInstance(t, controller);
