...
namespace zLearnHub.Data
{
    public class ControllerConfiguration
    {
        ...
        protected virtual void Initialize(XPathNavigator navigator)
        {
            ...
            {
                var t = ApplicationServices.StringToType("zLearnHub.Rules.SharedBusinessRules");
                if (t != null)
        ...
        public virtual void Complete()
        {
            ...
            if (string.IsNullOrEmpty(_connectionStringName))
                _connectionStringName = "zLearnHub";
...
<action id=""a5"" commandName=""Edit"" causesValidation=""true"" />
        ...
        public string LoadLayout(string view)
        {
            ...
            while (tryLoad)
            {
                ...
                {
                    var stream = GetType().Assembly.GetManifestResourceStream(string.Format("zLearnHub.Views.{0}.{1}.html", this.ControllerName, view));
                    if (stream != null)
                    {
